    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form   action="{{url('user', [$data['user']['id']])}}"   accept-charset="UTF-8" method="POST" enctype="multipart/form-data">
                        {{ method_field('PUT') }}
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="firstname" type="text" class="form-control @error('firstname') is-invalid @enderror" name="firstname" value="{{$data['user']['firstname']}}" required autocomplete="firstname" autofocus>
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="zipcode" type="text" class="form-control @error('zipcode') is-invalid @enderror" name="zipcode" value="{{$data['user']['zipcode']}}" required autocomplete="state" autofocus>
